...
*
*/
void MapLatLonToXY(double phi, double lambda, double lambda0, UTMCoord& xy) {
...
*   N, nu2, t, and t2 in MapLatLonToXY,
...
*
*/
void MapXYToLatLon(double x, double y, double lambda0, WGS84Coord& philambda) {
...
*/
void LatLonToUTM(double lat, double lon, int zone, UTMCoord& xy) {
...
*
* Outputs:
*	latlon - A 2-element array containing the latitude and longitude of the point, in radians.
*
* Returns:
*	The function does not return a value.
*
*/
void UTMtoLatLon(double x, double y, int zone, bool southhemi, WGS84Coord& latlon) {
	x -= 500000.0;
	x /= UTM_Scale_Factor;
